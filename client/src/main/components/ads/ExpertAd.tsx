...
const ExpertAd: FC<AdProps> = ({ onChangeLevel }) => {
  return (
    <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow  xl:p-8">
      ...
      <ul role="list" className="mb-8 space-y-4 text-left">
        ...
        <li className="flex items-center space-x-3">
          ...
          <span>Comprehensible Analytics</span>
        </li>
        <li className="flex items-center space-x-3">
          <svg
            className="h-5 w-5 flex-shrink-0 text-green-500 "
        ...
        <li className="flex items-center space-x-3">
          ...
          <span>
            <span className="font-semibold">Bulk</span> API
          </span>
        </li>
      </ul>
      {/* <a
      ...
      <ButtonBlue className="mt-auto" onClick={() => onChangeLevel(2)} text="Go Expert!" />
    </div>
  );
};

export default ExpertAd;
